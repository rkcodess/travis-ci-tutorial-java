[![Build Status](https://app.travis-ci.com/rkcodess/travis-ci-tutorial-java.svg?branch=master)](https://app.travis-ci.com/rkcodess/travis-ci-tutorial-java)
[![Code Coverage](https://codecov.io/github/rkcodess/travis-ci-tutorial-java/coverage.svg)](https://codecov.io/gh/rkcodess/travis-ci-tutorial-java)
...
[Click here for the example using GitHub Actions instead of Travis CI](https://github.com/rkcodess/github-ci-tutorial-java)

# How To Start

1. [Fork](https://github.com/rkcodess/travis-ci-tutorial-java/fork) this Repository
2. Go to [Travis CI](http://travis-ci.com) and enable the repository
3. Fix the `README.md` badges (replacing in the URL `rkcodess` with `your-github-username`) and push the changes. This should trigger a build in Travis CI!
...
[Open an Issue](https://github.com/rkcodess/travis-ci-tutorial-java/issues/new)!
